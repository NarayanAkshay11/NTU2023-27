...
float pitch_acc;
float roll_acc;
char sbuf[16][15]; //16 rows just in case you wanna keep 2 graphs together
float pitch_gyro = 0;
float roll_gyro = 0 ;
float yaw_gyro = 0;
...
int main(void)
{
  ...
  /* The below block is done just to check the values of accelerometer, only uncomment and do it in case the TA asks, else submit the final code and enjoy */
